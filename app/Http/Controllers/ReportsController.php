...
class ReportsController extends Controller
{
    ...
    private function downloadJob($date_from,$date_to,$status,$type){
        ...
        $data = ReportRepo::init()->getJobs($date_from,$date_to,$status);
    ...
    private function downloadPo($date_from,$date_to,$status,$type)
    {
        ...
        $data = ReportRepo::init()->getPos($date_from,$date_to,$status);
    ...
    {
        $data = ReportRepo::init()->getLeads($date_from,$date_to);
