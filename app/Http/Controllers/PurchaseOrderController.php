...
//
        $invumID = InvNum::insertGetId(
            [
                ...
                //extra fields
                'ucIDInvBLNo' => null, //$po->quotation->dms->bl_number,
                'ucIDInvVoyageNo' => null,
                'ucIDInvVessel' => null,
                'ucIDInvQty' => null, //$po->quotation->dms->cargo_weight, //tonnes measurementv
                'ucIDInvConsignee' => null, //$po->quotation->cargo->consignee_name,
                'ucIDInvClientRef' => null, //$po->quotation->dms->ctm_ref,
                //end
