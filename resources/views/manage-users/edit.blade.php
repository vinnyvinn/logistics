            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-material m-t-40 manage-staff" action="{{ route('manage-users.update', $user->id) }}" method="post">
                            {{ csrf_field() }}
                            {{ method_field('put') }}
                            <div class="row">
                                <div class="col-sm-6">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            $('.manage-staff').on('submit', function (e) {
                e.preventDefault();
                ...
                if (validated) {
                    ...
                    $('.pass_placeholder').css('color', 'red').text('Password must contain atleast 1 digit,1 lowercase character,1 uppercase character and must not be less than 8 characters.');
                    $('.btnClick').attr('disabled', false).val('Update');
                    return true;
                }
