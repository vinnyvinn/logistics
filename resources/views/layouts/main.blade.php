...
<head>
    ...
    <title>Sovereign Logistics</title>
    <link type="text/css" media="all" href="{{ asset('assets/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('css/print.css') }}" type="text/css" media="print" id="theme" rel="stylesheet">
