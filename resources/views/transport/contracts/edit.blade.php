            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="contact_form" class="m-t-40" action="{{ route('contracts.update', $contract) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('put') }}
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="contract_type" id="contract_type" required class="form-control">
                                            ...
                                            <option {{ $contract->contract_type == 'agent' ? 'selected' : '' }} value="agent">Agent </option>
                                            <option {{ $contract->contract_type == 'company' ? 'selected' : '' }} value="company">Company</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="value">Any Charges</label>
                                        <input type="text" value="{{ $contract->value }}" required id="value" name="value" class="form-control" placeholder="Value">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="contact">Contact </label>
                                        <input type="text" required id="contact" value="{{ $contract->contact }}" name="contact" class="form-control" placeholder="Contact">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">Address </label>
                                        <input type="text" required id="address" value="{{ $contract->address }}" name="address" class="form-control" placeholder="Address">
                                    </div>
                                    <div class="form-group">
                                        <label for="remarks">Upload Doc</label>
                                        <input type="file" required id="remarks" name="remarks" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-12">
